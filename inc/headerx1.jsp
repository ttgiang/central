	...
	<tr class="<%=(String)session.getAttribute("aseBGColor")%>BGColor">
		<td valign="top">
			...
			<div id="course" class="dropmenudiv">
				...
				<a href="/central/core/crscrt.jsp?edt=PRE">CREATE NEW OUTLINE</a>
			...
			<div id="report" class="dropmenudiv">
				<a href="/central/core/crsassrpt.jsp">Outline Assessment Report</a>
			...
			<div id="utilities" class="dropmenudiv">
				<a href="/central/core/appridx.jsp">Approver Sequence Maintenance</a>
				...
				<a href="/central/core/maillog.jsp">View Mail Log</a>
			</div>
