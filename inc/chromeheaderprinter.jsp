						...
						<TR>
							<TD colspan="3" align="center">
								...
								%>
									&nbsp;&nbsp;
									(
									<a class="linkcolumn" href="vwcrsx.jsp#" onclick="ddaccordion.collapseall('technology'); return false">Collapse</a>
									<font class="copyright">&nbsp;&nbsp;|&nbsp;&nbsp;</font>
									<a class="linkcolumn" href="vwcrsx.jsp#" onclick="ddaccordion.expandall('technology'); return false">Expand</a>
									)
								<%
									}
								%>
