 ...
 * @author ttgiang
 *
 * added type policy to check for valid file types
 *
 */
...
public class MultipartParser {
  ...
  public MultipartParser(HttpServletRequest req, int maxSize, boolean buffer,
    ...
    this(req, maxSize, buffer, limitLength, encoding, null);
   ...
   *                    read past the end of the stream.
   * @param encoding the encoding to use for parsing, default is ISO-8859-1.
   * @param typePolicy determines whether the file extension is acceptable.
   */
  public MultipartParser(HttpServletRequest req,
  									int maxSize,
  									boolean buffer,
  ...
  public Part readNextPart() throws IOException {
    ...
    if (filename == null) {
      ...
      if (filename.equals("")) {
		...
		// ASE modified this section to prevent unwanted type from uploading
