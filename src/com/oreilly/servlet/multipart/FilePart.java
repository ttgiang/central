...
public class FilePart extends Part {
  ...
  public long writeTo(File fileOrDirectory) throws IOException {
		...
		return writeTo(fileOrDirectory,"");

  }

  public long writeTo(File fileOrDirectory,String prefix) throws IOException {
    long written = 0;
    ...
    try {
      ...
      if (fileName != null) {
        ...
        if (fileOrDirectory.isDirectory()) {
          ...
          //
          // if a prefix exists, prepend (ttg - 2013.07.01)
          //
          if(prefix != null && prefix.length() > 0){
				 file = new File(fileOrDirectory, prefix + "_" + fileName);
			 }
			 else{
