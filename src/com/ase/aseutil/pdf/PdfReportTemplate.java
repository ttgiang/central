...
public class PdfReportTemplate {
	...
	private static Logger logger = Logger.getLogger(PdfReportTemplate.class.getName());
	...
	*/
	...
	public static void initParams(){
		...
		logger.info("PdfReportTemplate initialized...");
	}
	...
	**/
	public static void writePDF(HttpServletRequest request,
		...
		try {
			...
			try {
				...
				logger.fatal("PdfReportTemplate - writePDF: " + e.toString());
			} finally {
				if (bis != null)
					bis.close();
	...
	public static String convertToDOSCharacters(String junk) {
		...
		try{
			...
			logger.fatal("PdfReportTemplate - convertToDOSCharacters - ex: " + ex.toString());
		}
