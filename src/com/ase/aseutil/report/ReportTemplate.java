...
public class ReportTemplate {
	...
	public static int dataFontSize 							= 9;
	public static int titleFontSize							= 10;

	public static int headerFontSize							= 9;
	public static int footerFontSize							= 9;
	...
	*/
	...
	public static void initParams(){
		...
		logger.info("ReportTemplate initialized...");
	}
		...
		*/
		public void onEndPage(PdfWriter writer, Document document) {
			...
			try {
				...
				// print campus name in header
				table.getDefaultCell().setBorder(Rectangle.NO_BORDER);
				Phrase phrase = new Phrase();

				// print user name, outline title and page #
				...
				phrase = new Phrase();
				phrase.setFont(myFont.getFooterFont());
				phrase.add(AseUtil.getCurrentDateTimeString());
				table.addCell(phrase);
				...
				logger.fatal("ReportTemplate: onEndPage - " + ex.toString());
			}
		}
	...
	*/
	public static class MyFontFactory implements FontProvider {
		...
		public Font getFont(String fontname,String encoding,boolean embedded,float size,int style,BaseColor color) {
			...
			// OR this single line
			//return new Font(Font.FontFamily.TIMES_ROMAN, size, Font.NORMAL, color);
		}
	...
	**/
	public static void writePDF(HttpServletRequest request,
		...
		try {
			...
			try {
				...
				logger.fatal("ReportTemplate - writePDF: " + e.toString());
			} finally {
				if (bis != null)
					bis.close();
	...
	public static String convertToDOSCharacters(String junk) {
		...
		try{
			...
			logger.fatal("ReportTemplate - convertToDOSCharacters - ex: " + ex.toString());
		}
	...
	public static void processElement(Document document,String junk,int line) {
		...
		try{
			...
			logger.fatal("ReportTemplate - processElements - iae:\nLine: " + line + "\nJunk: " + junk + "\nError: " + iae.toString());
		} catch(RuntimeException re){
			logger.fatal("ReportTemplate - processElements - re:\nLine: " + line + "\nJunk: " + junk + "\nError: " + re.toString());
		} catch(Exception ex){
			logger.fatal("ReportTemplate - processElements - ex:\nLine: " + line + "\nJunk: " + junk + "\nError: " + ex.toString());
		}
		*/
