...
public class DiffUtil {
  ...
  // Defaults.
  // Set these on your DiffUtil instance to override the defaults.
   ...
   */
  public LinkedList<Diff> diff(String text1, String text2) {
  ...
  public LinkedList<Diff> diff(String text1, String text2,
    ...
    return diff(text1, text2, checklines, deadline);
  }
   ...
   * @return Linked List of Diff objects.
   */
  private LinkedList<Diff> diff(String text1, String text2,
  ...
  private LinkedList<Diff> diff_lineMode(String text1, String text2,
    ...
    LinkedList<Diff> diffs = diff(text1, text2, false, deadline);
    ...
    while (thisDiff != null) {
      ...
      case EQUAL:
        ...
        if (count_delete >= 1 && count_insert >= 1) {
          ...
          for (Diff newDiff : diff(text_delete, text_insert, false,
              deadline)) {
            pointer.add(newDiff);
          }
        }
  ...
  private LinkedList<Diff> diff_bisectSplit(String text1, String text2,
    ...
    LinkedList<Diff> diffs = diff(text1a, text2a, false, deadline);
    LinkedList<Diff> diffsb = diff(text1b, text2b, false, deadline);
  ...
  public int diff_xIndex(LinkedList<Diff> diffs, int loc) {
	...
	*/
	public String showHtml(LinkedList<Diff> diffs) {
  ...
  public LinkedList<Patch> patch_make(String text1, String text2) {
    ...
    LinkedList<Diff> diffs = diff(text1, text2, true);
    if (diffs.size() > 2) {
      diff_cleanupSemantic(diffs);
    ...
    for (Patch aPatch : patches) {
      ...
      if (start_loc == -1) {
        ...
        if (text1.equals(text2)) {
          ...
          // indices.
          LinkedList<Diff> diffs = diff(text1, text2, false);
          if (text1.length() > this.Match_MaxBits
