...
public class JunkData {
	...
	**/
	...
	public JunkData(String campus,String userid,String historyid,String descr,String s1){
		this.campus = campus;
		this.userid = userid;
	...
	public JunkData(int i1,int i2,int i3,int i4,int i5,int i6,int i7,int i8,int i9,int i0){
		this.int1 = i1;
		this.int2 = i2;
		this.int3 = i3;
		this.int4 = i4;
	...
	public JunkData(String s1,String s2,String s3,String s4,String s5,String s6,String s7,String s8,String s9){
		this.string1 = s1;
		this.string2 = s2;
		this.string3 = s3;
		this.string4 = s4;
	...
	public JunkData(String s1,String s2,String s3,String s4,String s5,String s6,String s7,String s8,String s9,String s0){
		this.string1 = s1;
		this.string2 = s2;
		this.string3 = s3;
		this.string4 = s4;
	...
	public JunkData(String campus,String userid,String historyid,String courseAlpha,String courseNum,String courseType,String descr,
	...
	public JunkData(String campus,String userid,String historyid,String courseAlpha,String courseNum,String courseType,String descr,
						int i1,int i2,int i3,int i4,int i5,int i6,int i7,int i8,int i9,int i0){
