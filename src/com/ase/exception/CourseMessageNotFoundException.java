...
/**
 * Thrown if a nonexistant CourseMessage was attempting to be loaded.
 */
public class CourseMessageNotFoundException extends CentralException {
	 ...
	 *
	 */
	public CourseMessageNotFoundException() {
		super();
	 ...
	 * @param message
	 */
	public CourseMessageNotFoundException(String message) {
		super(message);
	 ...
	 * @param cause
	 */
	public CourseMessageNotFoundException(String message, Throwable cause) {
		super(message, cause);
	 ...
	 * @param cause
	 */
	public CourseMessageNotFoundException(Throwable cause) {
		super(cause);
