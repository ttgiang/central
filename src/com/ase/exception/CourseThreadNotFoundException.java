...
/**
 * Thrown if a nonexistant CourseThread was attempting to be loaded.
 */
public class CourseThreadNotFoundException extends CentralException {
	 ...
	 *
	 */
	public CourseThreadNotFoundException() {
		super();
	 ...
	 * @param message
	 */
	public CourseThreadNotFoundException(String message) {
		super(message);
	}
	 ...
	 * @param cause
	 */
	public CourseThreadNotFoundException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause
	 */
	public CourseThreadNotFoundException(Throwable cause) {
		super(cause);
	}
