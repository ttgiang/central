...
<%
	...
	**/
	...
	if (processPage){
		...
		out.println("<strong>header text created</strong>" + Html.BR());
		out.println(process01(conn,"tblcoursequestions") + " rows in tblcoursequestions updated" + Html.BR());
		out.println(process01(conn,"tblCampusQuestions") + " rows in tblCampusQuestions updated" + Html.BR());
		out.println(process01(conn,"tblProgramQuestions") + " rows in tblProgramQuestions updated" + Html.BR());

		out.println("" + Html.BR());

		out.println("<strong>misc table updated</strong>" + Html.BR());
		out.println(process02(conn) + " rows in tblMisc updated" + Html.BR());
