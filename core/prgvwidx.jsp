...
<%
	/**
	*	ASE
	*	prgvwidx.jsp - difference between this and prgidx is this is CUR and the other is PRE
	*	2007.09.01
	**/
...
<%
	...
	asePool.freeConnection(conn,"prgvwidx",user);
%>
