...
<%
	/**
	*	ASE
	*	crsrvwsts.jsp - outline review status (does not need alpha selection)
	*	2007.09.01
	**/
	...
	String pageTitle = "Outline Review Status";
...
<%
	try{
		if (processPage){
			...
			ReviewDB.showReviewsJQuery(conn,campus,user,idx,false);
%>
		  <div id="container90">
				<div id="demo_jui">
...
<%
	...
	asePool.freeConnection(conn,"crsrvwsts",user);
