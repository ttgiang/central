...
<%
	/**
	*	ASE
	*	crsbkx.jsp - delete linker entry
	*	2007.09.01
	**/
	...
	if (formName != null && formName.equals("aseForm") ){
		if (kix != null){
			...
			if ("r".equals(action)){
				Text text = TextDB.getText(conn,kix,seq);
				if (text!=null){
					title = text.getTitle();
	...
	fieldsetTitle = "Delete Text and Material";

	fieldsetTitle = "Delete Text and Material";
	inputTitle = "Text and Material";
...
<head>
	...
	<script type="text/javascript" src="js/crsbkx.js"></script>
</head>
...
<form method="post" action="/central/servlet/txt" name="aseForm">
	<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
		<TBODY>
			...
			<TR height="20">
				...
				<TD class="datacolumn"><%=title%>, <%=author%></TD>
			</TR>
			<TR height="20">
