...
<%
	...
	// 1. must have form tag
	// 2. include formfieldlimiter.js
	// 3. include <div id=\"question-status\"></div>
	// 4. include the script with reference to form name and div tag
%>
...
<%
	...
	**/
	...
	out.println(drawHTMLField(conn,"text","","credits","Test",50,50,false,campus,false));
	out.println("<br/>End");
	...
	public String drawHTMLFieldX(Connection conn,
		...
		try {
			...
			if ("1".equals(countText) && countThistext){
				...
				html = html + "<p><font class=\"textblackth\"><div id=\"question-status\"></div>";
			}
			else
...
<script type="text/javascript">
	fieldlimiter.setup({
	 thefield: document.aseForm.credits,
	 maxlength: 10,
	 statusids: ["question-status"], //id(s) of divs to output characters limit in the form [id1, id2, etc]. If non, set to empty array [].
