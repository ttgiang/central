...
<%
	...
	out.println(showOutlinesNeedingApproval(conn,out,campus,user,"REVIEW"));

	asePool.freeConnection(conn);
%>

<%!
	public static String showOutlinesNeedingApproval(Connection conn,
		javax.servlet.jsp.JspWriter out,
		String campus,String user,String caller){
