...
<%
	...
	**/
	...
	//out.println(drawHTMLField(conn,"radio","STATUS","status","1",50,50,false,campus,false));
	out.println("<br/>End");
	...
	public String drawHTMLFieldX(Connection conn,
		...
		try {
			...
			if ("1".equals(countText) && countThistext){
				...
				html = html
					+ "<p><font class=\"textblackth\">characters remaining: </font> "
					+ "<input readonly class=\"input\" type=\"text\" name=\"textLen\" size=\"3\" maxlength=\""+fieldMax+"\" value=\""+actualFieldLen+"\"></p>";
			}
			else
