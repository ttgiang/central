...
try{
	...
	if (rs.getString("email") != null){
		...
		// Open record
		String strsql = "SELECT * FROM `users` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
		...
		String srchfld = "'" + tmpfld + "'";
			...
			strsql = "SELECT * FROM `users` WHERE `user_login` = '" + srchfld +"'";
			...
			if (rschk.next()) {
				out.print("Duplicate key for user_login, value = " + tmpfld + "<br>");
...
<p><span class="jspmaker">Add to TABLE: users<br><br><a href="userslist.jsp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="usersadd.jsp" method="post">
<p>
...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	...
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% if (x_user_level== null || ((String)x_user_level).equals("")) {x_user_level = "0"; } // set default value %><input type="text" name="x_user_level" size="30" value="<%= HTMLEncode((String)x_user_level) %>"></span>&nbsp;</td>
	</tr>
	<tr>
