			...
			for(int i=0; i<totalItems; i++){
				...
				if ( cccm6100 != null ){
					...
					sb.append("<h2 class=\"expand\">"+pageCounter+". "+question+"</h2>")
						...
						.append(extraData)
						.append("<div id=\"aseEditorTextDiv"+question_friendly+"\" style=\"visibility: show\">"+HTMLFormField+"</div>");

					sb.append("<p class=\"top\">");
					sb.append("<div class=\"commands\" id=\"editorCommand\">");
					sb.append("<div><a href=\"#content\" class=\"linkcolumn\">"+cmdTop+"</a></div>");
					if(ckEditorControl == 1){
						sb.append("<div><a href=\"#\" onClick=\"return createEditor('"+itemEditorName+"','"+question_friendly+"',"+ckEditorControl+",'"+kix+"');\">"+cmdEdit+"</a></div>");
					}
					sb.append("</div> <!-- commands -->");
					sb.append("</p>");
					...
					if(!lock){
							sb.append("<div class=\"commands\" id=\"otherCommands\" style=\"visibility: hidden\">");
							...
							sb.append("<div id=\"progress_"+question_friendly+"\"></div>");
