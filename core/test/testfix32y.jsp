...
<%
	/**
	*	ASE
	*	testfix32y.jsp - moving 'is hours spent' from X32 to C20. X32 will be checkmarks (BY CAMPUS)
	...
	public static String processItem(Connection conn,String campus){
		...
		try{
			...
			while (rs.next()){
				...
				sql = "UPDATE tblCampusData SET " + fromField + "=? WHERE historyid=?";
