...
out.println("" + stepCounter + ": " + sql[i]+"<br>");
			...
			sql[1] = "INSERT INTO tblCoReq SELECT * FROM tblTempCoreq WHERE campus=? AND coursealpha=? AND coursenum=? AND coursetype='ARC'";
			sql[2] = "INSERT INTO tblPreReq SELECT * FROM tblTempPreReq WHERE campus=? AND coursealpha=? AND coursenum=? AND coursetype='ARC'";
			sql[3] = "INSERT INTO tblCourseAssess SELECT * FROM tblTempCourseAssess WHERE campus=? AND coursealpha=? AND coursenum=? AND coursetype='ARC'";
			sql[4] = "INSERT INTO tblCourseComp SELECT * FROM tblTempCourseComp WHERE campus=? AND coursealpha=? AND coursenum=? AND coursetype='ARC'";
			sql[5] = "INSERT INTO tblCourseContent SELECT * FROM tblTempCourseContent WHERE campus=? AND coursealpha=? AND coursenum=? AND coursetype='ARC'";
			for (i=0;i<tableCounter;i++){
out.println("" + stepCounter + ": " + sql[i]+"<br>");
				preparedStatement = conn.prepareStatement(sql[i]);
				preparedStatement.setString(1, campus);
