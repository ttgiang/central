...
<%
	/**
	*	ASE
	*	prgfstrk.jsp - fast track outline approval
	*	2007.09.01
	**/
	...
	String pageTitle = "Fast Track Program Approval";
...
<head>
	...
	<script language="JavaScript" src="js/prgfstrk.js"></script>
...
<table width="100%" cellspacing='1' cellpadding='2' align="center"  border="0">
	<tr><td align="center" class="textblackthcenter">
		<%
			...
			out.println(courseDB.setPageTitle(conn,"",alpha,"",campus));
		%>
	</td></tr>
</table>
<br/>
			...
			<table width="100%" cellspacing='0' cellpadding='0' align="left"  border="0">
				<tr>
					<td>
						...
						<legend>Fast Track Program Approval</legend>
						<form method="post" action="/central/servlet/amidala" name="aseForm">
							<%
								if (processPage){
							...
							%>
									...
									<input type="hidden" value="fstrk" name="ack">
							<%
								}
							%>
						</form>
						<p>
							<B>NOTE</B>: Fast track approval forces CC to approve <font class="goldhighlights"><%=alpha%></font> up to and including the
	...
	<tr>
		<td width="100%" valign="top">
			...
			<table width="100%" cellspacing='0' cellpadding='0' align="left"  border="0">
				...
				<tr>
					<td align="center">
						<br/><br/><a href="prgsts.jsp" class="linkcolumn">program approval status</a>
					</td>
				</tr>
			</table>
		</td>
...
<%
	asePool.freeConnection(conn,"prgfstrk",user);
%>
