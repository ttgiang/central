	...
	<table border="0" width="100%" id="table1" height="90%">
		...
		<tr>
			<td height="50%" align="center">
				<form method="post" action="ssx.jsp" name="aseForm">

					<fieldset class="FIELDSET50">
						<legend><font color="#000">Secret Santa - screen 1 of 4</font></legend>
						...
						<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
							<TBODY>
								<TR>
									<TD align="center">
										<br/>
										<strong>To begin the search for your Secret Santa, click next.</strong>
									</TD>
								</TR>
								...
								<TR>
									<TD align="center">
										<br />
										<input id="cmdYes" title="continue with request" type="submit" <%=disabled%> value="Next" class="inputsmallgray<%=off%>" onClick="return checkForm('s')">&nbsp;
