...
<%
	...
	*	ASE
	*	listarc.jsp
	*	2007.09.01	list archived courses
	**/
	...
	String pageTitle = "List Archived Outlines";
...
<head>
	...
	<script language="JavaScript" src="js/listarc.js"></script>
</head>
...
<%
	try{
		...
		out.println("		<form method=\'post\' name=\'aseForm\' action=\'viewarc.jsp\'>" );
		...
		if ( request.getParameter("abc") != null ){
			...
			sql = "SELECT distinct tpc.CourseAlpha + ' ' + tpc.CourseNum as A, " +
				...
				"FROM tblArchivesCourse tpc, tblCourse tc " +
