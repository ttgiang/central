...
<body background="../images/background.gif" topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
  ...
  <%
		...
		String insidePage = central + "cas_index.jsp";
		...
		if (logout != null) {
			netId = doCasLogin(request, response, webLogin + "/logout", frontPage, insidePage, conn, context);
			return;
		}
		...
		if(netId == null || netId == ""){
			netId = doCasLogin(request, response, webLogin, frontPage, insidePage, conn, context);
		}
