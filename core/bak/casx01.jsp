...
protected void doCasLoginX(HttpServletRequest req,
                          HttpServletResponse res,
                          String casUrl,
                          String frontPage,
                          String insidePage) throws Exception {
...
System.out.println("doWebLogin");
System.out.println("----------");
System.out.println("weblogin: " + weblogin);
...
System.out.println("doCasLogin; ticket     : " + ticket);
System.out.println("doCasLogin; weblogin     : " + weblogin);
System.out.println("doCasLogin; frontPage : " + frontPage);
...
System.out.println("doCasLogin; uh-cas uid : " + uid);
