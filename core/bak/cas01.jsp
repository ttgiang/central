...
/*
insidePage = "cctest.its.hawaii.edu:8080/central/core/index.jsp";
serviceURL = URLEncoder.encode(insidePage, "UTF-8");
frontPage  = request.getRequestURL().toString();
String netId = "";
doCasLogin(request, response, webLogin, frontPage, insidePage);
*/
