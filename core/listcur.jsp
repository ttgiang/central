...
<%
	...
	*	ASE
	*	listcur.jsp
	*	2007.09.01	list curent courses
	**/
	...
	String pageTitle = "List Current Outlines";
...
<head>
	...
	<script language="JavaScript" src="js/listcur.js"></script>
</head>
...
<%
	try{
		...
		out.println("		<form method=\'post\' name=\'aseForm\' action=\'viewcur.jsp\'>" );
		...
		if ( request.getParameter("abc") != null ){
			...
			sql = "SELECT distinct tpc.CourseAlpha + ' ' + tpc.CourseNum as A, " +
				...
				"FROM tblCurrentCourse tpc, tblCourse tc " +
