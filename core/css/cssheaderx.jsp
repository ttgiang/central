<table border="0" width="100%" id="asetable2" cellspacing="0" cellpadding="3">
	<tr class="<%=(String)session.getAttribute("aseBGColor")%>BGColor">
		<td valign="top">
			<%
				...
				if (	(String)session.getAttribute("aseApplicationTitle") != null && headerCampus != null ) {
					...
					out.println("<li><a href=\"/central/core/cssindex.jsp\">Home</a></li>" +
						"<li><a href=\"/central/core/csstasks.jsp\">My Tasks</a></li>" +
					...
					out.println("<li><a href=\"https://login.its.hawaii.edu/cas/logout?service=http://"
						+ aseServer
				...
				if (userLevel>=Constant.FACULTY){
					...
					out.println("<b>Approval</b>" +
						...
						"<a href=\"/central/core/crscanappr.jsp?edt=PRE\">&nbsp;&nbsp;&nbsp;&nbsp;Request Outline Approval</a>");
		...
		<td class="<%=(String)session.getAttribute("aseBGColor")%>BGColor" align="right">
