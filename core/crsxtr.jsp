...
<%
	...
	**/
	...
	if (processPage && (Constant.COURSE_RECPREP).equals(src)){
...
<%
							...
							<table width="100%" cellspacing='1' cellpadding='2' border="0">
								<tr class="textblackTRTheme" + session.getAttribute("aseTheme") + "">
									...
									<td class="textbrownTH" width="10%">&nbsp;
										...
										%>
											<a href="/centraldocs/docs/help/V_EnterRecPrep.swf" class="linkColumn" target="_blank"><img src="../images/vol.gif" border="0" alt="show help video" title="show help video"></a>&nbsp;&nbsp;
										<%
											}
										%>
										<!--
										<a href="crshlp.jsp?t=-1&h=<%=help%>" class="linkColumn" onclick="return hs.htmlExpand(this, { objectType: 'ajax', width: 500})"><img src="images/helpicon.gif" border="0" alt="show help" title="show help"></a>
										-->
	...
	asePool.freeConnection(conn,"crsxtr",user);
%>
