...
public class MyJTable extends JFrame {
	...
	public void createPdf(boolean shapes) {
		...
		try {
			...
			PdfWriter writer;
			if (shapes)
				writer = PdfWriter.getInstance(document, new FileOutputStream("c:\\tomcat\\webapps\\central\\core\\testj\\my_jtable_shapes.pdf"));
			else
				writer = PdfWriter.getInstance(document, new FileOutputStream("c:\\tomcat\\webapps\\central\\core\\testj\\my_jtable_fonts.pdf"));
