 ...
 * @author Marc A. Mnich
 */
public class TestBroker implements Runnable {
	...
	*/
	public TestBroker(String dbDriver, String dbServer, String dbLogin,
	...
	*/
	...
	private void setupBroker(String dbDriver, String dbServer, String dbLogin,
		...
		log.println("-----------------------------------------");
		log.println("-----------------------------------------");
		log.println("Starting TestBroker Version 1.0.13:");
	...
	*/
	public static void main(String[] args) throws Exception {
		...
		try{
			...
			TestBroker broker = new TestBroker(driver,url,user,password,1,1,"c:\\tomcat\\webapps\\central\\logs\\asepool.log",1.0);
		}
		catch (Exception e){
