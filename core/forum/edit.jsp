...
%>
		<FORM NAME="aseForm" ACTION="editx.jsp" METHOD="post">
		...
		<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="4" width="700" align="left">
			...
			<TR >
				...
				<TD width="90%"><INPUT class="input" TYPE="text" NAME="subject" MAXLENGTH="50" VALUE="<%=subject%>" size="110"></INPUT></TD>
			</TR>
			<TR >
			...
			<TR >
				...
				<TD width="90%" COLSPAN="2"><INPUT class="input" <%=checked%> TYPE="checkbox" NAME="notify" VALUE="1"> E-mail me when someone posts a new message in this thread.</TD>
			</TR>

			<TR height="40">
			<TD width="10%" class="textblackth">&nbsp;</TD>
			<TD width="90%"  valign="bottom" ALIGN="left">
				<INPUT class="input" TYPE="submit" VALUE="Update Reply" id="cmdSubmit" name="cmdSubmit" onClick="return validateForm();">&nbsp;&nbsp;
				<INPUT class="input" TYPE="reset" VALUE="Reset Form" id="cmdReset" name="cmdReset">&nbsp;&nbsp;
...
<%
	...
	asePool.freeConnection(conn,"edit",user);
%>
</p>
