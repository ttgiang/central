...
/*
	TTG001 - not displaying the font name and size
	TTG001 - 1 line of toolbar buttons (tCounter)
*/
...
\* ---------------------------------------------------------------------- */
	...
	tCounter = 0;
	buttonName[tCounter++]  = "cut";
	buttonName[tCounter++]  = "copy";
	buttonName[tCounter++]  = "paste";
	buttonName[tCounter++]  = "seperator";
	buttonName[tCounter++]  = "undo";
	buttonName[tCounter++]  = "redo";
	buttonName[tCounter++]  = "seperator";
	buttonName[tCounter++]  = "bold";
	buttonName[tCounter++]  = "italic";
	buttonName[tCounter++]  = "underline";
	buttonName[tCounter++]  = "strikethrough";
	buttonName[tCounter++]  = "seperator";
	buttonName[tCounter++]  = "subscript";
	buttonName[tCounter++]  = "superscript";
	buttonName[tCounter++]  = "seperator";
	buttonName[tCounter++]  = "justifyleft";
	buttonName[tCounter++]  = "justifycenter";
	buttonName[tCounter++] = "justifyright";
	buttonName[tCounter++] = "seperator";
	buttonName[tCounter++] = "unorderedlist";
	buttonName[tCounter++] = "orderedlist";
	buttonName[tCounter++] = "outdent";
	buttonName[tCounter++] = "indent";
	buttonName[tCounter++]  = "forecolor";
	buttonName[tCounter++]  = "backcolor";
	buttonName[tCounter++]  = "seperator";
	buttonName[tCounter++]  = "viewSource";
	buttonName[tCounter++]  = "seperator";
	buttonName[tCounter++]  = "help";
...
function generate_wysiwyg(textareaID) {
	...
	// ttg
	//document.getElementById(n).style.bgGolor = "yellow";
