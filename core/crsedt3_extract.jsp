			...
			if (!messagePage){
				...
				if (question_type.equals("wysiwyg")){
					...
					if(useCkEditor){
						...
						if (tester.equals(faculty)){
							questionData[0] += Html.BR()
													+ Html.BR() + "question_friendly: " + question_friendly
													+ Html.BR() + "question_ini: " + question_ini
													+ Html.BR() + "extraButton: " + extraButton
													+ Html.BR() + "extraForm: " + extraForm
													+ Html.BR() + "extraTitle: " + extraTitle;
						}
					...
					if (tester.equals(faculty)){
						HTMLFormField = aseUtil.drawHTMLField(conn,
												...
												question_ini,
												controlName,
												screenData + " - " + question_friendly + " - " + question_explain,
												question_len,
												question_max,
												lock,
												campus,
					...
					if(question_explain!=null && question_explain.length()>0){
						...
						if(useCkEditor){
							...
							if (tester.equals(faculty)){
								...
								HTMLFormFieldExplain += Html.BR()
															+ Html.BR() + "question_friendly: " + question_friendly
															+ Html.BR() + "question_explain: " + question_explain
															+ Html.BR() + "question_ini: " + question_ini
															+ Html.BR() + "extraButton: " + extraButton
															+ Html.BR() + "extraForm: " + extraForm
															+ Html.BR() + "extraTitle: " + extraTitle;
