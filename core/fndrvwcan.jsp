...
<%
	/**
	*	ASE
	*	fndrvwcan.jsp	- cancel outline review request
	*	2007.09.01
	**/
	...
	if(level > 1){
		...
		if(level == 0 && user.equals(fnd.getFndItem(conn,kix,"proposer"))){
			level = 1;
		}
	}
...
<head>
	...
	<script language="JavaScript" src="js/fndrvwcan.js"></script>
...
<%
	...
	%>
		<form method="post" action="fndrvwcanx.jsp" name="aseForm">
	...
	asePool.freeConnection(conn,"fndrvwcan",user);
