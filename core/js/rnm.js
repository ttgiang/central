	...
	function validateForm0(action){
		...
		if (document.aseForm && document.aseForm.approvalDate && document.aseForm.approvalDate.value != ''){
			var currentDate = new Date();
			var userDate = new Date(document.aseForm.approvalDate.value);
			...
			if (result < 1){
				...
				document.aseForm.approvalDate.focus();
				rtn = false;
			}
			else
				rtn = true;
