...
<form method="post" action="crsmodezz.jsp" name="aseForm">
	<TABLE width='80%' cellspacing='1' cellpadding='2' class='tableBorder<%=session.getAttribute("aseTheme")%>' align='center'  border='0'>
		<TBODY>
			<tr>
				<td colspan="2">
					<%
						out.println(ModeDB.getProcessStep3(conn,campus,process,item,request,id,overRide));
					%>
				</td>
			</tr>
			<tr>
				<td colspan="2">
					...
					<div class="hr"></div>
					<p align="right">
					<input type="submit" class="input" name="cmdSubmit" value="Save" title="save process" onClick="return checkFormW()">&nbsp;&nbsp;
...
<%
	asePool.freeConnection(conn,"crsmodez",user);
%>
